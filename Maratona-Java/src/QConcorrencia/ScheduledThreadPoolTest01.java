...
//		executor.schedule(r, 5, TimeUnit.SECONDS); // passa o runnable e o tempo do beep
		ScheduledFuture<?> scheduleWithFixedDelay = executor.scheduleWithFixedDelay(r, 1, 5, TimeUnit.SECONDS);// passa o runnable o beep inicial e o intervalo
