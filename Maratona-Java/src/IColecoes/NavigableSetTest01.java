...
import IColecoes.dominio.Smartphone;
...
class SmartphoneMarcaComparator implements Comparator<Smartphone>{
	...
	class MangaValorComparator implements Comparator<Manga>{
...
public class NavigableSetTest01 {
	...
	public static void main(String[] args) {
		...
		NavigableSet<Manga> mangas = new TreeSet<>(new MangaValorComparator());
